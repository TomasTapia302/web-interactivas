            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="num_telefono" class="col-md-4 col-form-label text-md-end">{{ __('telefono') }}</label>

                            <div class="col-md-6">
                                <input id="num_telefono" type="text" class="form-control @error('num_telefono') is-invalid @enderror" name="num_telefono" value="{{ old('num_telefono') }}" required autocomplete="num_telefono" autofocus>
